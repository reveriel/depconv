...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x1asecond/protos/target.proto\x12\rsecond.protos\x1a\x1bsecond/protos/anchors.proto\x1a\x1esecond/protos/similarity.proto\"\x8d\x05\n\x0c\x43lassSetting\x12G\n\x17\x61nchor_generator_stride\x18\x01 \x01(\x0b\x32$.second.protos.AnchorGeneratorStrideH\x00\x12\x45\n\x16\x61nchor_generator_range\x18\x02 \x01(\x0b\x32#.second.protos.AnchorGeneratorRangeH\x00\x12R\n\x1d\x61nchor_generator_sphere_range\x18\x03 \x01(\x0b\x32).second.protos.AnchorGeneratorSphereRangeH\x00\x12,\n\tno_anchor\x18\x04 \x01(\x0b\x32\x17.second.protos.NoAnchorH\x00\x12O\n\x1cregion_similarity_calculator\x18\x05 \x01(\x0b\x32).second.protos.RegionSimilarityCalculator\x12\x1b\n\x13use_multi_class_nms\x18\x06 \x01(\x08\x12\x16\n\x0euse_rotate_nms\x18\x07 \x01(\x08\x12\x18\n\x10nms_pre_max_size\x18\x08 \x01(\x05\x12\x19\n\x11nms_post_max_size\x18\t \x01(\x05\x12\x1b\n\x13nms_score_threshold\x18\n \x01(\x02\x12\x19\n\x11nms_iou_threshold\x18\x0b \x01(\x02\x12\x19\n\x11matched_threshold\x18\x0c \x01(\x02\x12\x1b\n\x13unmatched_threshold\x18\r \x01(\x02\x12\x12\n\nclass_name\x18\x0e \x01(\t\x12\x18\n\x10\x66\x65\x61ture_map_size\x18\x0f \x03(\x03\x42\x12\n\x10\x61nchor_generator\"\x87\x02\n\x0eTargetAssigner\x12\x33\n\x0e\x63lass_settings\x18\x01 \x03(\x0b\x32\x1b.second.protos.ClassSetting\x12 \n\x18sample_positive_fraction\x18\x02 \x01(\x02\x12\x13\n\x0bsample_size\x18\x03 \x01(\r\x12\x18\n\x10\x61ssign_per_class\x18\x04 \x01(\x08\x12\x19\n\x11nms_pre_max_sizes\x18\x05 \x03(\x03\x12\x1a\n\x12nms_post_max_sizes\x18\x06 \x03(\x03\x12\x1c\n\x14nms_score_thresholds\x18\x07 \x03(\x03\x12\x1a\n\x12nms_iou_thresholds\x18\x08 \x03(\x03\x62\x06proto3')
  ,
...
_CLASSSETTING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anchor_generator_sphere_range', full_name='second.protos.ClassSetting.anchor_generator_sphere_range', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='no_anchor', full_name='second.protos.ClassSetting.no_anchor', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='region_similarity_calculator', full_name='second.protos.ClassSetting.region_similarity_calculator', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_multi_class_nms', full_name='second.protos.ClassSetting.use_multi_class_nms', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='use_rotate_nms', full_name='second.protos.ClassSetting.use_rotate_nms', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_pre_max_size', full_name='second.protos.ClassSetting.nms_pre_max_size', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_post_max_size', full_name='second.protos.ClassSetting.nms_post_max_size', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_score_threshold', full_name='second.protos.ClassSetting.nms_score_threshold', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nms_iou_threshold', full_name='second.protos.ClassSetting.nms_iou_threshold', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='matched_threshold', full_name='second.protos.ClassSetting.matched_threshold', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unmatched_threshold', full_name='second.protos.ClassSetting.unmatched_threshold', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='class_name', full_name='second.protos.ClassSetting.class_name', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='feature_map_size', full_name='second.protos.ClassSetting.feature_map_size', index=14,
...
_CLASSSETTING.fields_by_name['anchor_generator_sphere_range'].message_type = second_dot_protos_dot_anchors__pb2._ANCHORGENERATORSPHERERANGE
...
_CLASSSETTING.oneofs_by_name['anchor_generator'].fields.append(
  _CLASSSETTING.fields_by_name['anchor_generator_sphere_range'])
_CLASSSETTING.fields_by_name['anchor_generator_sphere_range'].containing_oneof = _CLASSSETTING.oneofs_by_name['anchor_generator']
_CLASSSETTING.oneofs_by_name['anchor_generator'].fields.append(
