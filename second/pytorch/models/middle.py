...
class SparseMiddleExtractor(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_siz):
        # coors[:, 1] += 1
        coors = coors.int()
...
class SpMiddleFHD(nn.Module):
    def __init__(self,
        ...
        self.middle_conv = spconv.SparseSequential(
            subm00 = SubMConv3d(num_input_features, 16, 3, indice_key="subm0"),
            bn0 = BatchNorm1d(16),
            relu0 = nn.ReLU(),
            subm01 = SubMConv3d(16, 16, 3, indice_key="subm0"),
            bn1 = BatchNorm1d(16),
            relu1 = nn.ReLU(),
            conv1 = SpConv3d(16, 32, 3, 2,
                     padding=1),  # [1600, 1200, 41] -> [800, 600, 21]
            bn2 = BatchNorm1d(32),
            relu2 = nn.ReLU(),
            subm10 = SubMConv3d(32, 32, 3, indice_key="subm1"),
            bn3 = BatchNorm1d(32),
            relu3 = nn.ReLU(),
            subm11 = SubMConv3d(32, 32, 3, indice_key="subm1"),
            bn4 = BatchNorm1d(32),
            relu4 = nn.ReLU(),
            conv2 = SpConv3d(32, 64, 3, 2,
                     padding=1),  # [800, 600, 21] -> [400, 300, 11]
            bn5 = BatchNorm1d(64),
            relu5 = nn.ReLU(),
            subm20 = SubMConv3d(64, 64, 3, indice_key="subm2"),
            bn6 = BatchNorm1d(64),
            relu6 = nn.ReLU(),
            subm21 = SubMConv3d(64, 64, 3, indice_key="subm2"),
            bn7 = BatchNorm1d(64),
            relu7 = nn.ReLU(),
            subm22 = SubMConv3d(64, 64, 3, indice_key="subm2"),
            bn8 = BatchNorm1d(64),
            relu8 = nn.ReLU(),
            conv3 = SpConv3d(64, 64, 3, (2,1,1),
                     padding=[0, 1, 1]),  # [400, 300, 11] -> [200, 150, 5]
            bn9 = BatchNorm1d(64),
            relu9 = nn.ReLU(),
            subm30 = SubMConv3d(64, 64, 3, indice_key="subm3"),
            bn10 = BatchNorm1d(64),
            relu10 = nn.ReLU(),
            subm31 = SubMConv3d(64, 64, 3, indice_key="subm3"),
            bn11 = BatchNorm1d(64),
            relu11 = nn.ReLU(),
            subm32 = SubMConv3d(64, 64, 3, indice_key="subm3"),
            bn12 = BatchNorm1d(64),
            relu12 = nn.ReLU(),
            conv4 = SpConv3d(64, 64, (3, 1, 1),
...
class SphMiddleFHD(nn.Module):
    def __init__(self,
                 ...
                 num_filters_down2=[64, 64],
                 name='SphMiddleFHD'):
        super(SphMiddleFHD, self).__init__()
        self.name = name
        if use_norm:
            BatchNorm2d = change_default_args(
                eps=1e-3, momentum=0.01)(nn.BatchNorm2d)
            BatchNorm1d = change_default_args(
                eps=1e-3, momentum=0.01)(nn.BatchNorm1d)
            Conv2d = change_default_args(bias=False)(nn.Conv2d)
            SpConv3d = change_default_args(bias=False)(sphconv.SparseConv3d)
            SubMConv3d = change_default_args(bias=False)(sphconv.SubMConv3d)
            ConvTranspose2d = change_default_args(bias=False)(
                nn.ConvTranspose2d)
        else:
            BatchNorm2d = Empty
            BatchNorm1d = Empty
            Conv2d = change_default_args(bias=True)(nn.Conv2d)
            SpConv3d = change_default_args(bias=True)(sphconv.SparseConv3d)
            SubMConv3d = change_default_args(bias=True)(sphconv.SubMConv3d)
            ConvTranspose2d = change_default_args(bias=True)(
                nn.ConvTranspose2d)
        sparse_shape = np.array(output_shape[1:4]) + [1, 0, 0]
        # sparse_shape[0] = 11
        ...
        self.voxel_output_shape = output_shape
        # input: # [1600, 1200, 41]
        self.middle_conv = sphconv.SparseSequential(
            subm00 = SubMConv3d(num_input_features, 16, 3,
                              indice_key="subm0", name="subm0:0"),
            bn0 = BatchNorm1d(16),
            relu0 = nn.ReLU(),
            subm01 = SubMConv3d(16, 16, 3, indice_key="subm0", name="subm0:1"),
            bn1 = BatchNorm1d(16),
            relu1 = nn.ReLU(),
            conv1 = SpConv3d(16, 32, 3, 2, padding=1, name="conv1"),
              # [1600, 1200, 41] -> [800, 600, 21]
            bn2 = BatchNorm1d(32),
            relu2 = nn.ReLU(),
            subm10 = SubMConv3d(32, 32, 3, indice_key="subm1", name="subm1:0"),
            bn3 = BatchNorm1d(32),
            relu3 = nn.ReLU(),
            subm11 = SubMConv3d(32, 32, 3, indice_key="subm1", name="subm1:1"),
            bn4 = BatchNorm1d(32),
            relu4 = nn.ReLU(),
            conv2 = SpConv3d(32, 64, 3, 2, padding=1, name="conv2"),
              # [800, 600, 21] -> [400, 300, 11]
            bn5 = BatchNorm1d(64),
            relu5 = nn.ReLU(),
            subm20 = SubMConv3d(64, 64, 3, indice_key="subm2", name="subm2:0"),
            bn6 = BatchNorm1d(64),
            relu6 = nn.ReLU(),
            subm21 = SubMConv3d(64, 64, 3, indice_key="subm2", name="subm2:1"),
            bn7 = BatchNorm1d(64),
            relu7 = nn.ReLU(),
            subm22 = SubMConv3d(64, 64, 3, indice_key="subm2", name="subm2:2"),
            bn8 = BatchNorm1d(64),
            relu8 = nn.ReLU(),
            conv3 = SpConv3d(64, 64, 3, (1,2,1), padding=[1, 0, 1], name="conv3"),
              # [400, 300, 11] -> [200, 150, 5]
            bn9 = BatchNorm1d(64),
            relu9 = nn.ReLU(),
            subm30 = SubMConv3d(64, 64, 3, indice_key="subm3", name="subm3:0"),
            bn10 = BatchNorm1d(64),
            relu10 = nn.ReLU(),
            subm31 = SubMConv3d(64, 64, 3, indice_key="subm3", name="subm3:1"),
            bn11 = BatchNorm1d(64),
            relu11 = nn.ReLU(),
            subm32 = SubMConv3d(64, 64, 3, indice_key="subm3", name="subm3:2"),
            bn12 = BatchNorm1d(64),
            relu12 = nn.ReLU(),
            conv4 = SpConv3d(64, 64, (1, 3, 1), (1, 2, 1), padding=0, name="conv4"),
              # [200, 150, 5] -> [200, 150, 2]
            bn13 = BatchNorm1d(64),
            relu13 = nn.ReLU(),
        )
    ...
    def forward(self, rvoxels):
        # coors[:, 1] += 1
        print("rvoxels shape: ", rvoxels.shape)
        # t = time.time()
        # torch.cuda.synchronize()
        ret = self.middle_conv(rvoxels)
        # torch.cuda.synchronize()
        # print("spconv forward time", time.time() - t)
        ret = ret.dense()  #- | /
