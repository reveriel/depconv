...
class SphMiddleFHD(nn.Module):
    def __init__(self,
        ...
        self.middle_conv = sphconv.SparseSequential(
            SubMConv3d(num_input_features, 16, 3, indice_key="subm0"), BatchNorm1d(16),
            nn.ReLU(),
            SubMConv3d(16, 16, 3, indice_key="subm0"),
            BatchNorm1d(16),
            nn.ReLU(),
            ...
            BatchNorm1d(64),
            nn.ReLU(),
            SpConv3d(64, 64, 3, (1,2,1),
                     padding=[1, 0, 1]),  # [400, 300, 11] -> [200, 150, 5]
            BatchNorm1d(64),
            nn.ReLU(),
            SubMConv3d(64, 64, 3, indice_key="subm3"),
            BatchNorm1d(64),
            ...
            BatchNorm1d(64),
            nn.ReLU(),
            SpConv3d(64, 64, (1, 3, 1),
                     (1, 2, 1), padding=(0,0,0)),  # [200, 150, 5] -> [200, 150, 2]
            BatchNorm1d(64),
            nn.ReLU(),
        )
        self.max_batch_size = 6
