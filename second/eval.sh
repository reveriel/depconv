...
# CUDA_VISIBLE_DEVICES=1 python3 ./pytorch/train.py train  \
 # --config_path=configs/car.fhd.config --model_dir=depconv26 --resume=True \
 # --multi_gpu=False

CUDA_VISIBLE_DEVICES=1 python3 ./pytorch/train.py evaluate  \
 --config_path=configs/car.fhd.config --model_dir=depconv91 --measure_time=True \
 --batch_size=1
...
# python3 ./pytorch/train.py evaluate --config_path=./configs/car.fhd.config \
# --model_dir=second1 --measure_time=True --batch_size=1
